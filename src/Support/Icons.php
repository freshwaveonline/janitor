 ...
 *
 * Deliberately inlined rather than pulled from an icon package: an error page
...
class Icons
{
    ...
    private const PATHS = [
        ...
        'key' => 'M15.75 5.25a3 3 0 013 3m3 0a6 6 0 01-7.029 5.912c-.563-.097-1.159.026-1.563.43L10.5 17.25H8.25v2.25H6v2.25H2.25v-2.818c0-.597.237-1.17.659-1.591l6.499-6.499c.404-.404.527-1.001.43-1.563A6 6 0 1121.75 8.25z',
        ...
        'shield-exclamation' => 'M12 9v3.75m0-10.036A11.959 11.959 0 013.598 6 11.99 11.99 0 003 9.75c0 5.592 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.31-.21-2.571-.598-3.751h-.152c-3.196 0-6.1-1.25-8.25-3.286zm0 13.036h.008v.008H12v-.008z',
        ...
        'signal-slash' => 'M9.348 14.652a3.75 3.75 0 010-5.304m5.304 0a3.75 3.75 0 010 5.304m-7.425 2.121a6.75 6.75 0 010-9.546m9.546 0a6.75 6.75 0 010 9.546M5.106 18.894c-3.808-3.807-3.808-9.98 0-13.788m13.788 0c3.808 3.807 3.808 9.98 0 13.788M3 3l18 18',
    ...
    /**
     * Default icon per HTTP status code.
     *
    ...
    private const STATUS_ICONS = [
        ...
        405 => 'hand-raised',
        408 => 'clock',
        409 => 'arrows-right-left',
        410 => 'archive-box',
        413 => 'cloud-arrow-up',
        419 => 'arrow-path',
        422 => 'clipboard-document-check',
        423 => 'lock-closed',
        429 => 'clock',
        500 => 'bug-ant',
        501 => 'no-symbol',
    ...
    public static function forStatus(int $status): string
    {
        ...
        return $status >= 500 ? 'exclamation-triangle' : 'exclamation-circle';
    }
    ...
    public static function svg(string $name, array $attributes = []): HtmlString
    {
        ...
        return new HtmlString(
            '<svg'.$rendered.'><path d="'.htmlspecialchars($path, ENT_QUOTES, 'UTF-8').'"/></svg>'
        );
    }

    /**
     * The bare path data, for the JavaScript pop-up which builds its own SVG.
     */
